      ...
      <tr v-for="section in sections">
        ...
        <td>
          <div class="ace-settings-item btn-group clearfix">
            ...
            <button v-show="hasResource(BUSINESS_COURSE_MANAGEMENT_UPDATE)" v-on:click="edit(section)" class="btn btn-xs btn-info">
              <i class="ace-icon fa fa-pencil bigger-120"></i>
            </button>&nbsp;
            <button v-show="hasResource(BUSINESS_COURSE_MANAGEMENT_DELETE)" v-on:click="del(section.id)" class="btn btn-xs btn-danger">
                  ...
                  <div v-show="section.video" class="row">
                    <div class="col-md-9">
                      <player v-bind:player-id="'form-player-div'"
                              ref="player"></player>
                      <video v-bind:src="section.video" id="video-time" controls="controls" class="hidden"></video>
                    </div>
                  </div>
                </div>
              </div>
  ...
  export default {
    ...
    methods: {
      ...
      getTime() {
        let _this = this;
        setTimeout(function () {
          let ele = document.getElementById("video-time");
