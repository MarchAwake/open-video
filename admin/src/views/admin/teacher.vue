<template>
  <div>
    <p>
      <button v-show="hasResource(BUSINESS_TEACHER_MANAGEMENT_UPDATE)" v-on:click="add()" class="btn btn-white btn-default btn-round">
    ...
    <div v-show="hasResource(BUSINESS_TEACHER_MANAGEMENT_BROWSER)" class="row">
      <div v-for="teacher in teachers" class="col-md-3">
        ...
        <div v-show="hasResource(BUSINESS_TEACHER_MANAGEMENT_UPDATE)" class="profile-social-links align-center">
          <button v-on:click="edit(teacher)" class="btn btn-xs btn-info">
            <i class="ace-icon fa fa-pencil bigger-120"></i>
          </button>
          &nbsp;
          <button v-show="hasResource(BUSINESS_TEACHER_MANAGEMENT_DELETE)" v-on:click="del(teacher.id)" class="btn btn-xs btn-danger">
  ...
  export default {
    ...
    data: function() {
      return {
        ...
        teachers: [],
        FILE_USE: FILE_USE,
        BUSINESS_TEACHER_MANAGEMENT_BROWSER : BUSINESS_TEACHER_MANAGEMENT_BROWSER,
        BUSINESS_TEACHER_MANAGEMENT_UPDATE : BUSINESS_TEACHER_MANAGEMENT_UPDATE,
        BUSINESS_TEACHER_MANAGEMENT_DELETE : BUSINESS_TEACHER_MANAGEMENT_DELETE,
      }
    },
    mounted: function() {
      let _this = this;
    ...
    methods: {
      ...
      afterUpload(resp) {
        ...
        _this.teacher.image = resp.data.path;
      }
    }
  }
</script>