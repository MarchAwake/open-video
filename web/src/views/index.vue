  ...
  <main role="main">
    ...
    <section class="jumbotron text-center">
      <div class="container">
        ...
        <p>
          <router-link to="/list" class="btn btn-primary my-2 p-3 font-weight-bold">知识大海</router-link>
        </p>
      </div>
    </section>
  ...
  export default {
    ...
    methods: {
      ...
      listNew() {
        ...
        _this.$ajax.get(process.env.VUE_APP_SERVER + '/business/web/course/new-list').then((response)=>{
