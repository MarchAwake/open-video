package cn.marchawake.generator.enums;

import cn.marchawake.server.enums.*;
...
//    static String path = "web\\public\\static\\js\\enums.js";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            toJson(EmailboxUseEnum.class, bufferObject, bufferArray);
            toJson(EmailboxStatusEnum.class, bufferObject, bufferArray);
